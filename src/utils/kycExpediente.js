...
const ETIQUETAS = {
  ...
  venc_identificacion: 'Fecha de caducidad del documento',
  empleador_nombre_comercial: 'Empresa donde labora — Nombre comercial',
  empleador_razon_social: 'Empresa donde labora — Razón social',
  empleador_tipo_sociedad: 'Empresa donde labora — Tipo de sociedad',
  empleador_actividad: 'Empresa donde labora — Actividad',
  empleador_telefono: 'Empresa donde labora — Teléfono',
  empleador_correo: 'Empresa donde labora — Correo de contacto',
  empleador_web: 'Empresa donde labora — Página web',
  empleador_puesto: 'Puesto que desempeña',
  empleador_antiguedad: 'Tiempo de laborar en la empresa',
  pep: '¿Es persona expuesta políticamente (PEP)?',
  pep_puesto: 'Puesto PEP que ocupa u ocupó',
  pep_tiempo: 'Tiempo desde que dejó el cargo',
